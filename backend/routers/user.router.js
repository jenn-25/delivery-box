...
import {register, update, login, logout, changePassword, sendPasswordResetOTP, resetPassword, getMyInfo, isOTPCodesCorrect, validateMyPassword} from '../controllers/user.controller.js';
